    ...
    <StyledBookingDataBox>
      ...
      <Section>
        <Guest>
          ...
          <p>
            مهمان ها :{guestName} {numGuests > 1 ? ` + ${numGuests - 1} ` : ""}
          </p>
          <span>&bull;</span>
          <p>{email}</p>
          <span>&bull;</span>
        ...
        <DataItem icon={<HiOutlineCheckCircle />} label="شامل صبحانه ؟">
        ...
        <Price isPaid={isPaid}>
          ...
          <p>{isPaid ? "پرداخت شده" : "در انتظار پرداخت"}</p>
        </Price>
      </Section>

      <Footer>
        <p>رزرو شده {format(new Date(created_at), "EEE, MMM dd yyyy, p")}</p>
      </Footer>
    </StyledBookingDataBox>
  );
}
